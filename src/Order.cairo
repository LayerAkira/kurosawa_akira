...
fn get_gas_fee_and_coin(gas_fee: GasFee, cur_gas_price: u32, native_token:ContractAddress, cur_gas_per_action:u32) -> (u256, ContractAddress) {
    ...
    let spend_native: u256 = cur_gas_per_action.into() * cur_gas_price.into();
